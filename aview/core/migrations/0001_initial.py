    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appointment_with', models.ManyToManyField(blank=True, related_name='appointment_with', to=settings.AUTH_USER_MODEL)),
                ('hospital', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='hospital', to='core.profile')),
                ('patient', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='patient', to='core.profile')),
            ],
        ),
    ]
